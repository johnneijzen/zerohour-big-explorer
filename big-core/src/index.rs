...
impl IndexReader {
    ...
    pub fn read_entries_from<R: Read + Seek>(&self, r: &mut R, offset: u64, count: u32) -> anyhow::Result<Vec<Entry>> {
        ...
        for _ in 0..count {
            ...
            let rtype = if tlen == 0 { None } else { Some(String::from_utf8_lossy(&tbuf).into_owned()) };
